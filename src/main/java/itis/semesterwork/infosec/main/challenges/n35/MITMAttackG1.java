...
public class MITMAttackG1 implements DiffieHellmanConversation {
    ...
    public MITMAttackG1(DiffieHellmanConversation intendedFriend) {
        this.intendedFriendB = intendedFriend;
    }

    public BigInteger initConversation(BigInteger p, BigInteger g, BigInteger publicKey) {
        if (!BigInteger.valueOf(1).equals(g)) throw new IllegalArgumentException("Attack works only for g = 1");
